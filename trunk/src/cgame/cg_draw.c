...
//	rectDef_t headHintRect =	{ 40, 480 - 22, 20, 20 };
	...
	bg_character_t* headcharacter = BG_GetCharacter( cgs.clientinfo[ cg.snap->ps.clientNum ].team, cgs.clientinfo[ cg.snap->ps.clientNum ].cls, cgs.clientinfo[ cg.snap->ps.clientNum ].characterType );
