...
//	{ "speconly",			qtrue,	qtrue,	NULL, ":^7 Toggles option to stay as a spectator in 1v1" },
	...
	{ "team",				qtrue,	qtrue,	Cmd_Team_f, " <b|r|s>:^7 Joins a team (b = allies, r = axis, s = spectator)" },
	{ "class",				qtrue,  qtrue,  Cmd_Class_f, " <s|e|m|f|c>:^7 Selects a class for the next spawn (s=soldier e=engineer m=medic f=field-ops c=covert-ops)" },
	{ "nextteam",			qtrue,  qtrue,  Cmd_NextTeam_f, " <b|r|s>:^7 Selects a team to change to after the next class command" },
...
//
//TODO: move this out of the OSP specific section! (quad)
