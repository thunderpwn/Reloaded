...
bg_character_t	alliedMemberCharacters[NUM_PLAYER_CLASSES];
bg_character_t	axisMemberCharacters[NUM_PLAYER_CLASSES];

bg_character_t	alliedAdminCharacters[NUM_PLAYER_CLASSES];
bg_character_t	axisAdminCharacters[NUM_PLAYER_CLASSES];
	...
	*/
	...
	case CHARTYPE_MEMBERS:
		switch( team ) {
			default:
			case TEAM_AXIS:
				return &axisMemberCharacters[cls];
			case TEAM_ALLIES:
				return &alliedMemberCharacters[cls];
		}
	case CHARTYPE_ADMINS:
		switch( team ) {
			default:
			case TEAM_AXIS:
				return &axisAdminCharacters[cls];
			case TEAM_ALLIES:
				return &alliedAdminCharacters[cls];
		}
	}
}
