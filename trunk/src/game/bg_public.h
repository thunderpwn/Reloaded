...
#define FORCE_LIMBO_HEALTH2	-150 // tjw
...
// tjw: number of players allowed on one fireteam
...
typedef struct {
	...
	// tjw: the number of times the player has dropped the
	//      objective this life.
	int objDrops;
...
#define MISC_SHOW_KILLERHP 4 // Dens: show the hp of your attacker when you got killed
#define MISC_NOSELFDMG 8
#define MISC_JUMP_STAMINA 16 // Perro: Jumping takes stamina
...
// Medics with level 4 are always revived to full health
#define MEDIC_LVL4_FULLREVIVE 4
// Flag 8 unused
...
// Allow Medics to adren others
#define MEDIC_ADRENOTHER 128
// No self-adren
#define MEDIC_NOSELFADREN 256

// gabriel: medic regen rate

// Medics regenerate at 3/2 (system default)
#define MEDIC_REGENRATE32 0
// Medics regenerate at 2/2
#define MEDIC_REGENRATE22 1
// Medics regenerate at 2/1
#define MEDIC_REGENRATE21 2
// Medics regenerate at 2/0
#define MEDIC_REGENRATE20 3
// Medics regenerate at 1/1
#define MEDIC_REGENRATE11 4
// Medics regenerate at 1/0
#define MEDIC_REGENRATE10 5
// Medics don't regenerate health
#define MEDIC_REGENRATE00 6
// Medics only regenerate at full (normal) health
// 0/1
#define MEDIC_REGENRATE01 7
// 0/2
#define MEDIC_REGENRATE02 8


// tjw: g_coverts

// level 4 coverts have more scoped weapon accuracy
#define COVERTF_L4_MARKSMAN 1
// disquised coverts can't be spotted by scanning them with your crosshairs
#define COVERTF_TRUE_DISGUISE 2
// coverts don't switch back to satchel after firing one, main weapon instead
#define COVERTF_NO_SATCHEL_SWITCHBACK 4
// coverts take half-damage when disguised
#define COVERTF_DISGUISE_HALFDMG 8
// disguised covies take no splash (explosive) damage
#define COVERTF_DISGUISE_NOSPLASH 16
// coverts firing weapons around enemies will not lose uniform automatically
#define COVERTF_NO_FIRING_EXPOSURE 32
// covies can keep their uni when they fire non-silenced
#define COVERTF_KEEP_UNI_NONSIL 64
// disguised coverts can attach to mounted MG's without losing disguise
#define COVERTF_NO_MG_EXPOSURE 128
// coverts receive xp for contructive use of smoke
#define COVERTF_SMOKE_XP 256
// coverts lose disguise due to ANY weapon use in the presence of enemies
// this is contrary to etmain behaviour where knife/smoke/satchel are special
#define COVERTF_ANY_WEAP_FIRING_EXPOSURE 512
// disguised covert can steal another enemy uniform
#define COVERT_STEAL_OTHER_UNIFORM 1024
...
typedef enum {
	...
	//forty - hud editor save/load popup
	UIMENU_HUDEDITOR_SAVE,
	UIMENU_HUDEDITOR_LOAD,
...
bg_character_t *BG_GetCharacter( int team, int cls, charType_t type );
