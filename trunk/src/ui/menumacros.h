...
#define EDITFIELDLEFTEXT( EDITFIELDLEFTEXT_X, EDITFIELDLEFTEXT_Y, EDITFIELDLEFTEXT_W, EDITFIELDLEFTEXT_H, EDITFIELDLEFTEXT_TEXT, EDITFIELDLEFTEXT_TEXT_SCALE, EDITFIELDLEFTEXT_TEXT_ALIGN_Y, EDITFIELDLEFTEXT_CVAR, EDITFIELDLEFTEXT_MAXCHARS, EDITFIELDLEFTEXT_MAXPAINTCHARS, EDITFIELDLEFTEXT_EXT, EDITFIELDLEFTEXT_TOOLTIP )	\
	itemDef {														\
		name			"efleftext"##EDITFIELDLEFTEXT_TEXT						\
      	group			GROUP_NAME										\
      	rect			$evalfloat(EDITFIELDLEFTEXT_X) $evalfloat(EDITFIELDLEFTEXT_Y) $evalfloat(EDITFIELDLEFTEXT_W) $evalfloat(EDITFIELDLEFTEXT_H)	\
		type			ITEM_TYPE_EDITFIELD								\
		text			EDITFIELDLEFTEXT_TEXT								\
		textfont		UI_FONT_COURBD_21									\
		textstyle		ITEM_TEXTSTYLE_SHADOWED								\
		textscale		EDITFIELDLEFTEXT_TEXT_SCALE							\
		textaligny		EDITFIELDLEFTEXT_TEXT_ALIGN_Y							\
		forecolor		.6 .6 .6 1										\
		cvar			EDITFIELDLEFTEXT_CVAR								\
		maxChars		EDITFIELDLEFTEXT_MAXCHARS							\
		maxPaintChars	EDITFIELDLEFTEXT_MAXPAINTCHARS						\
		visible		1											\
		tooltip		EDITFIELDLEFTEXT_TOOLTIP							\
																\
		EDITFIELDLEFTEXT_EXT											\
    }

#define EDITFIELDACTION( EDITFIELDACTION_X, EDITFIELDACTION_Y, EDITFIELDACTION_W, EDITFIELDACTION_H, EDITFIELDACTION_TEXT, EDITFIELDACTION_TEXT_SCALE, EDITFIELDACTION_TEXT_ALIGN_Y, EDITFIELDACTION_CVAR, EDITFIELDACTION_MAXCHARS, EDITFIELDACTION_MAXPAINTCHARS, EDITFIELDACTION_ACTION, EDITFIELDACTION_TOOLTIP )	\
	itemDef {															\
		name			"efaction"##EDITFIELDACTION_TEXT						\
      	group			GROUP_NAME										\
      	rect			$evalfloat(EDITFIELDACTION_X) $evalfloat(EDITFIELDACTION_Y) $evalfloat(EDITFIELDACTION_W) $evalfloat(EDITFIELDACTION_H)	\
		type			ITEM_TYPE_EDITFIELD								\
		text			EDITFIELDACTION_TEXT							\
		textfont		UI_FONT_COURBD_21								\
		textstyle		ITEM_TEXTSTYLE_SHADOWED							\
		textscale		EDITFIELDACTION_TEXT_SCALE						\
		textalign		ITEM_ALIGN_RIGHT								\
		textalignx		$evalfloat(0.5*(EDITFIELDACTION_W))				\
		textaligny		EDITFIELDACTION_TEXT_ALIGN_Y					\
		forecolor		.6 .6 .6 1										\
		cvar			EDITFIELDACTION_CVAR							\
		maxChars		EDITFIELDACTION_MAXCHARS						\
		maxPaintChars	EDITFIELDACTION_MAXPAINTCHARS					\
		visible			1												\
		tooltip			EDITFIELDACTION_TOOLTIP							\
																		\
		onEnter {														\
			play "sound/menu/filter.wav" ;								\
			EDITFIELDACTION_ACTION										\
		}																\
	}
