...
//kw: used for playonline menu
extern vmCvar_t ui_browserShowModName;
extern vmCvar_t ui_browserFilterHost;

// tjw: custom fonts
extern vmCvar_t ui_font1;
extern vmCvar_t ui_font2;
extern vmCvar_t ui_font3;
extern vmCvar_t ui_font4;
extern vmCvar_t ui_font1size;
extern vmCvar_t ui_font2size;
extern vmCvar_t ui_font3size;
extern vmCvar_t ui_font4size;
...
#define MAX_MAPS 512	// kw: increased from 128
...
//----(SA)	end
	...
	char		browserFilterHost[MAX_STRING_CHARS];

	int fontIndex;
	int fontCount;
	const char *fontList[MAX_FONTS];
	qboolean fontDefaults;
