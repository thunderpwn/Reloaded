...
// tjw: big ugly global string declared in ui_main.c
extern char bigTextBuffer[30000];
...
static qboolean UI_ParseAnimationFile( const char *filename, playerInfo_t *pi ) {
	...
	// NERVE - SMF - new!!!!
	AnimParseAnimConfig( pi, filename, bigTextBuffer );
	return qtrue;
